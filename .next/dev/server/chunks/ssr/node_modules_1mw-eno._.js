...
"[project]/node_modules/sql.js/dist/sql-wasm.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
    ...
    initSqlJsPromise = new Promise(function(resolveModule, reject) {
        ...
        k.onRuntimeInitialized = function() {
            ...
            var g = y(4), h = k.cwrap, q = h("sqlite3_open", "number", [
                "string",
                "number"
            ]), v = h("sqlite3_close_v2", "number", [
                "number"
            ]), u = h("sqlite3_exec", "number", [
                "number",
                "string",
                "number",
                "number",
                ...
                "number"
            ]), nc = h("sqlite3_normalized_sql", "string", [
                "number"
                ...
                "number",
                "number"
            ]), pc = h("sqlite3_bind_double", "number", [
                "number",
                "number",
                "number"
            ]), qc = h("sqlite3_bind_int", "number", [
                "number",
                "number",
                "number"
            ]), rc = h("sqlite3_bind_parameter_index", "number", [
                "number",
                "string"
            ]), sc = h("sqlite3_step", "number", [
                "number"
            ]), tc = h("sqlite3_errmsg", "string", [
                "number"
            ]), uc = h("sqlite3_column_count", "number", [
                "number"
            ]), vc = h("sqlite3_data_count", "number", [
                "number"
            ]), wc = h("sqlite3_column_double", "number", [
                "number",
                "number"
            ]), sb = h("sqlite3_column_text", "string", [
                "number",
                "number"
            ]), xc = h("sqlite3_column_blob", "number", [
                "number",
                "number"
            ]), yc = h("sqlite3_column_bytes", "number", [
                "number",
                "number"
            ]), zc = h("sqlite3_column_type", "number", [
                "number",
                "number"
            ]), Ac = h("sqlite3_column_name", "string", [
                "number",
                "number"
            ]), Bc = h("sqlite3_reset", "number", [
                "number"
            ]), Cc = h("sqlite3_clear_bindings", "number", [
                "number"
            ]), Dc = h("sqlite3_finalize", "number", [
                "number"
            ]), tb = h("sqlite3_create_function_v2", "number", "number string number number number number number number number".split(" ")), hc = h("sqlite3_value_type", "number", [
                "number"
            ]), kc = h("sqlite3_value_bytes", "number", [
                "number"
            ]), jc = h("sqlite3_value_text", "string", [
                "number"
            ]), lc = h("sqlite3_value_blob", "number", [
                "number"
            ]), ic = h("sqlite3_value_double", "number", [
                "number"
            ]), ec = h("sqlite3_result_double", "", [
                "number",
                "number"
            ]), lb = h("sqlite3_result_null", "", [
                "number"
            ]), fc = h("sqlite3_result_text", "", [
                "number",
                "string",
                "number",
                "number"
            ]), gc = h("sqlite3_result_blob", "", [
                "number",
                "number",
                "number",
                "number"
            ]), dc = h("sqlite3_result_int", "", [
                "number",
                "number"
            ]), va = h("sqlite3_result_error", "", [
                "number",
                "string",
                "number"
        ...
        "undefined" != typeof ("TURBOPACK compile-time value", "/ROOT/node_modules/sql.js/dist/sql-wasm.js") ? za = ("TURBOPACK compile-time value", "/ROOT/node_modules/sql.js/dist/sql-wasm.js") : ba && (za = self.location.href);
        var Aa = "", Ba, Ca;
        if (ca) {
            var fs = __turbopack_context__.r("[externals]/node:fs [external] (node:fs, cjs)");
            Aa = ("TURBOPACK compile-time value", "/ROOT/node_modules/sql.js/dist") + "/";
            Ca = (a)=>{
                a = Da(a) ? new URL(a) : a;
        ...
        var Ea = console.log.bind(console), B = console.error.bind(console), Fa, Ga = !1, Ha, Da = (a)=>a.startsWith("file://"), m, C, Ia, E, F, Ja, Ka, H;
        function La() {
            var a = Ma.buffer;
            m = new Int8Array(a);
            Ia = new Int16Array(a);
        ...
        var nb = {
            ...
            b && (c |= 146);
            return c;
        }, Cb = null, Db = {}, Eb = [], Fb = 1, R = null, Gb = !1, Hb = !0, Ib = {}, N = class {
            name = "ErrnoError";
            constructor(a){
                this.Pa = a;
            }
        ...
        var Ec = void 0, Gc = ()=>{
            ...
            d: 124,
            e: 111
        }, Vc = (a)=>Tc(Array.from(a, (b)=>Uc[b])), wa = (a, b)=>{
            if (!Rc) {
                Rc = new WeakMap;
                var c = Z.length;
            ...
            try {
                ...
                b = Uint8Array.of(0, 97, 115, 109, 1, 0, 0, 0, 1, ...Tc([
                    1,
                    96,
                    ...Vc(b.slice(1)),
                    ...Vc("v" === b[0] ? "" : b[0])
        ...
        var da, ea, Bb, Wc, sa, y, qa, Ma, Z, Xc = {
            a: (a, b, c, d)=>Na(`Assertion failed: ${z(a)}, at: ` + [
            ...
            o: (a)=>{
                ...
                for(var c = 1; 4 >= c; c *= 2){
                    ...
                    a: {
                        d = (Math.min(2147483648, 65536 * Math.ceil(Math.max(a, d) / 65536)) - Ma.buffer.byteLength + 65535) / 65536 | 0;
                        try {
                            Ma.grow(d);
                            La();
                            var e = 1;
...
//# sourceMappingURL=node_modules_1mw-eno._.js.map